...
public class ChartJsDemoUI extends UI {
    ...
    static {
        ...
        MENU_ITEMS.add(new MenuItem(ChartType.BAR, "Annotation Plugin", AnnotationPluginChartView.class));
        ...
        MENU_ITEMS.add(new MenuItem(ChartType.LINE, "Zero line options", ZeroLineLineChartView.class));
    ...
    protected void init(VaadinRequest request) {
        ...
        Label info = new Label("<strong>" + title + "</strong> "
                ...
                + "| <a href=\"https://www.paypal.me/moberwasserlechner/\">Make a donation</a>"
        );
